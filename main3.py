...
img_bat0 = image.load("frame_0_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat1 = image.load("frame_1_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat2 = image.load("frame_2_delay-0.1s-removebg-preview.png").convert_alpha()
# img_bat3 = image.load("frame_3_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat4 = image.load("frame_4_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat5 = image.load("frame_5_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat6 = image.load("frame_6_delay-0.1s-removebg-preview.png").convert_alpha()
img_bat7 = image.load("frame_7_delay-0.1s-removebg-preview.png").convert_alpha()
...
class Player(GameSprite):
    ...
    def fire(self, speed):
        ...
        bullet_img = transform.rotate(
            transform.scale(image.load(img_bullet), (50, 30)),
